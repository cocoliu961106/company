    ...
    <div class="container frame">
        <div class="slider">
            <div class="window" @mouseover="stop" @mouseleave="play">
                <ul class="holder" :style="holderStyle">
                    <li>
                ...
                <ul class="direction">
                    <li class="left" @click="move(600, 1, speed)">
                        <svg class="icon" width="30px" height="30px" viewBox="0 0 1024 1024" version="1.1"
    ...
    export default {
        ...
        data() {
            return {
                sliders: [
                    {
                        img: require('assets/images/rays_ecological.png')
                    },
                    {
                        img: require('assets/images/rays_ecological.png')
                    },
